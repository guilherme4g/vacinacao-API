<h1 align="center"> Vacinação API </h1>	
  ...
  <p>
 	  <ul>
        ...
        <li> Caso a vacina tomada tenha mais de uma dose, não permitir que o <br> cidadão tome antes do tempo determinado para a segunda dose. </li>
    </ul>
  </p>
 ...
 <br>
 <img src="./assets/MER.png" alt="imagem do modelo entidade relacionamento">
